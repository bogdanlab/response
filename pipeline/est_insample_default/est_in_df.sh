...
do
    ...
    $mypython $src/hess.py \
        --prefix /u/project/pasaniuc/shihuwen/response_result/est_insample_default/est_insample_default_n_"$n"_hsq_"$hsq"_ncau_"$ncau"/sim_gwas_"$region_start"_"$region_stop"_"$idx"_step1 \
        --out /u/project/pasaniuc/shihuwen/response_result/est_insample_default/est_insample_default_n_"$n"_hsq_"$hsq"_ncau_"$ncau"/sim_gwas_"$region_start"_"$region_stop"_"$idx"_step2
        
    rm /u/project/pasaniuc/shihuwen/response_result/est_insample_default/est_insample_default_n_"$n"_hsq_"$hsq"_ncau_"$ncau"/sim_gwas_"$region_start"_"$region_stop"_"$idx"*.gz
done
