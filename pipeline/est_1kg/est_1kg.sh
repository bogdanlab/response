...
do
    $mypython $src/hess.py \
        ...
        --out /u/project/pasaniuc/shihuwen/response_result/est_1kg/est_1kg_n_"$n"_hsq_"$hsq"_ncau_"$ncau"/sim_gwas_"$region_start"_"$region_stop"_"$idx"_step1 \
        --partition /u/project/pasaniuc/shihuwen/response/pipeline/regions/chr22_"$region_start"_"$region_stop".bed
        
    $mypython $src/hess.py \
        --prefix /u/project/pasaniuc/shihuwen/response_result/est_1kg/est_1kg_n_"$n"_hsq_"$hsq"_ncau_"$ncau"/sim_gwas_"$region_start"_"$region_stop"_"$idx"_step1 \
        --out /u/project/pasaniuc/shihuwen/response_result/est_1kg/est_1kg_n_"$n"_hsq_"$hsq"_ncau_"$ncau"/sim_gwas_"$region_start"_"$region_stop"_"$idx"_step2
        
    rm /u/project/pasaniuc/shihuwen/response_result/est_1kg/est_1kg_n_"$n"_hsq_"$hsq"_ncau_"$ncau"/sim_gwas_"$region_start"_"$region_stop"_"$idx"*.gz
done
